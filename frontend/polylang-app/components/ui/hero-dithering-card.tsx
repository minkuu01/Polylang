        ...
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none opacity-40 dark:opacity-30 mix-blend-multiply dark:mix-blend-screen">
              <Dithering
                ...
                colorFront="#00E676"  // Accent
                shape="warp"
                type="4x4"
                speed={isHovered ? 0.35 : 0.2}
                className="size-full"
                minPixelRatio={1}
              />
            </div>
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            {/* Headline */}
            <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight text-foreground mb-8 text-balance leading-[1.05]">
              Your words, <br />
